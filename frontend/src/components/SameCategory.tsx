...
function SameCategory(){
    const [select,setSelect]=useState('vegetable')
    ...
    const changeHandler=(e:any)=>{
      ...
      useEffect(()=>{
      axios.post('http://localhost:8000/kitchen/samecategory',{category:select,headers:{"Content-type":"application/json"}})
 ...
 <Toolbar className={classes.toolbarContent}>
   ...
   <Controls.Button
     ...
     <Controls.Select name="category"  value={select}  onChange={changeHandler} error={null}
      options={[{id:"1",title:"fruit"},{id:"2",title:"vegetable"},{id:"3",title:"dairy"},{id:"4",title:"meat"},
      {id:"5",title:"fish"},{id:"6",title:"liquid"}]}
     />
