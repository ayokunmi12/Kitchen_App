...
function SameLocation(){
    ...
    const [select,setSelect]=useState('pantry')
    ...
    const changeHandler=(e:any)=>{
      ...
      useEffect(()=>{
      axios.post('http://localhost:8000/kitchen/samelocation',{location:select,headers:{"Content-type":"application/json"}})
 ...
 <Toolbar className={classes.toolbarContent}>
   ...
   <Controls.Button
     ...
     <Controls.Select name="category"  value={select}  onChange={changeHandler} error={null}
      options={[{id:"1",title:"pantry"},{id:"2",title:"fridge"},{id:"3",title:"freezer"}]}
     />
